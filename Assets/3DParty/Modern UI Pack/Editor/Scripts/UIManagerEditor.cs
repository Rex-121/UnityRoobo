    ...
    public class UIManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (changeRootFolder.boolValue == true)
            {
                ...
                if (GUILayout.Button("Set Default", customSkin.button, GUILayout.Width(113)))
                {
                    rootFolder.stringValue = "Modern UI Pack/Prefabs/";
                    EditorPrefs.SetString("UIManager.RootFolder", rootFolder.stringValue);
                }

                if (GUILayout.Button("Apply", customSkin.button, GUILayout.Width(113)))
                    EditorPrefs.SetString("UIManager.RootFolder", rootFolder.stringValue);

                GUILayout.EndHorizontal();
                GUILayout.Space(2);
                EditorGUI.indentLevel = 0;
                EditorGUILayout.HelpBox("Make sure that the Modern UI Pack directory matches. " +
            ...
            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            GUILayout.Label("ID: B16-20211028");
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
            GUILayout.Space(6);
        }
        ...
        void Twitter()
        {
            Application.OpenURL("https://www.twitter.com/michskyHQ");
        }
