...
public class LocalHttpServer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //    HttpListenerRequest request = content.Request;

        //    Logging.Log("Raw Url:{0}" + request.RawUrl);
        ...
        //    HttpListenerResponse response = content.Response;
        ...
        //var a = new HTTPRequest(new Uri("http://localhost:8080/"), callback: (r, re) =>
        //{
    ...
    private void Result(IAsyncResult ar)
    {
        ...
        else
        {
            if (request.HttpMethod == "GET")
            {
                ...
                returnObj = HandleRequest(request, response);
                //returnObj = string.Format("<HTML>hello,你访问了我</HTML>");
                //    byte[] buff = Encoding.UTF8.GetBytes(responseString);
                //    // 回复
                //    Stream output = response.OutputStream;
                //    output.Write(buff, 0, buff.Length);
