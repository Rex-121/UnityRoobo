...
public static class ScenesMenuBuild
{
    ...
    public static void UpdateList()
    {
        ...
        foreach (string sceneGuid in AssetDatabase.FindAssets("t:Scene", new string[] { "Assets/Scenes" }))
        {
            ...
            stringBuilder.AppendLine(string.Format("    [MenuItem(\"切换场景/{0}\", priority = 10)]", sceneName));
